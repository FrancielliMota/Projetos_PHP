<!-- Crie um formulário que permita ao usuário inserir a largura e a altura de um retângulo. O programadeve calcular a área do retângulo e exibir o resultado.  -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
